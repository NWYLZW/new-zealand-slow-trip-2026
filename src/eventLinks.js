...
const placeAliases = [
  ...
  ["Omega 取车", "Omega Rental Cars Queenstown Airport"],
  ["Omega 还车", "Omega Rental Cars Christchurch Airport"],
  ["Blue Peaks Lodge", "Blue Peaks Lodge Queenstown"],
  ["Edgewater Wānaka", "Edgewater Wānaka"],
  ...
  ["Redwoods", "Redwoods Whakarewarewa Forest"],
  ["Te Puia", "Te Puia Rotorua"],
  ["JetPark Hotel Rotorua", "JetPark Hotel Rotorua"],
];
