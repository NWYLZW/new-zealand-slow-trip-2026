...
export const oamaruHomeAdditionalHotels = [
  {
    ...
    availabilityNote:
      "2026-08-03 已在 Casa Nova House 官方 SiteMinder 预订页按 2026 年 10 月 6—7 日、2 人 1 间核验：Borton Chamber 可订，含税费总价 NZD 650，含早餐；页面标为“立即预订、稍后付款”。入住前 14 天外免费取消，14 天内收订单总额 50%，7 天内不可退款。",
    availabilityNoteEn:
      "Verified in Casa Nova House's direct SiteMinder engine on 3 Aug 2026 for 6–7 Oct, two guests and one room: the Borton Chamber was available at NZD 650 including taxes and fees, with breakfast included. It was labelled “Book now, pay later”. Cancellation is free more than 14 days before arrival, costs 50% within 14 days, and is non-refundable within seven days.",
    rateSnapshots: {
      "2026-10-06/2026-10-07": {
        roomRates: {
          "borton-chamber": {
            official: {
              source: "Casa Nova House 官网 SiteMinder",
              sourceEn: "Casa Nova House direct SiteMinder",
              roomKey: "borton-chamber",
              room: "Borton Chamber · King 床 · 独立卫浴",
              roomEn: "Borton Chamber · king bed · private en-suite",
              nonRefundableNzd: null,
              refundableNzd: 650,
              cancelUntil: "入住前超过 14 天免费取消；14 天内收 50%，7 天内不可退款",
              cancelUntilEn: "Free more than 14 days before arrival; 50% within 14 days and non-refundable within seven days",
              refundableRateLabel: "官网含税费总价 · 含早餐 · 分段取消政策",
              refundableRateLabelEn: "Direct total including taxes and fees · breakfast included · staged cancellation policy",
              payment: "页面标为“立即预订、稍后付款”；未显示具体扣款日期，付款前仍须复核",
              paymentEn: "Labelled “Book now, pay later”; the page did not state a specific charge date, so recheck before payment",
              breakfast: "包含按个人偏好与饮食需求定制的热食或欧陆式早餐",
              breakfastEn: "Includes a cooked or European-continental breakfast tailored to stated dietary needs",
              quotedAt: "2026-08-03",
            },
          },
        },
    ...
    officialStatusDetail:
      "2026-08-03 已在 Casa Nova House 官方 SiteMinder 预订页按 2026 年 10 月 6—7 日、2 人 1 间核验：Borton Chamber 可订，含税费总价 NZD 650，含早餐。页面标为“立即预订、稍后付款”；入住前 14 天外免费取消，14 天内收订单总额 50%，7 天内不可退款。页面没有给出具体扣款日期。",
    officialStatusEn:
      "Verified on 3 Aug 2026 in Casa Nova House's direct SiteMinder engine for 6–7 Oct 2026 and two guests: the Borton Chamber was available at NZD 650 including taxes and fees, with breakfast included. The rate was labelled “Book now, pay later”; cancellation is free more than 14 days before arrival, costs 50% within 14 days, and is non-refundable within seven days. No specific charge date was shown.",
    officialVerifiedAt: "2026-08-03",
    officialLinkRetainsSearch: true,
    officialUrl: "https://casanovahouse.co.nz/suites",
    officialBookingUrl: "https://book-directonline.com/properties/casanovahouse?locale=en&items[0][adults]=2&items[0][children]=0&items[0][infants]=0&currency=NZD&checkInDate=2026-10-06&checkOutDate=2026-10-07&trackPage=no",
  ...
  },
  {
    ...
    summary:
      "1889 年历史宅邸改造的主人经营精品 Lodge，仅有五间客房。推荐 Annex 二楼的 Garden Superior Room：一张可拆成双床的 Super King、独立起居区，以及带地暖、独立浴缸和淋浴的卫浴；官网精确日期页面显示其为 48 m²，并可订。房价包含早餐和税费。",
    summaryEn:
      "An owner-operated boutique lodge in an 1889 heritage home with only five guest rooms. The recommended upstairs Garden Superior Room in the Annex has a super-king bed convertible to twin king singles, a separate sitting area and an en-suite with underfloor heating, a separate bath and shower. The direct exact-date page lists it as 48 m² and available. The rate includes breakfast and taxes and fees.",
    ...
    strengths: [
      ...
      "Garden Superior Room 现显示为 48 m²，Super King 可拆双床，并有独立起居区",
      "卫浴有地暖、独立浴缸和淋浴；本次官网报价包含早餐和税费",
    ...
    strengthsEn: [
      ...
      "The Garden Superior Room is currently listed as 48 m², with a super-king bed convertible to twins and its own sitting area",
      "The en-suite has underfloor heating, a separate bath and shower; the current direct rate includes breakfast and taxes and fees",
    ...
    cautions: [
      "目标日期可订总价 NZD 890，高于此前仅作参考的公开起价；价格与库存仍会动态变化",
      "当前页面虽标示免费取消，但未显示免费取消截止时间或具体扣款日期",
      "Garden Room 在 Annex 二楼且只能走楼梯，不适合行动不便者",
      "官网没有公布最晚入住时间；企鹅晚场后到店必须提前电话或邮件协调",
      "一般取消期为 30 天：之后至入住前 15 天收 25%，再晚收 100%",
    ],
    cautionsEn: [
      "The target-date total is available at NZD 890, above the earlier reference starting rate; price and inventory remain dynamic",
      "The current page labels the rate as free cancellation, but does not show the deadline or a specific charge date",
    ...
    availabilityNote:
      "2026-08-03 已在 Pen-y-bryn Lodge 官方 SiteMinder 预订页按 2026 年 10 月 6—7 日、2 人 1 间核验：Garden Superior Room 可订，含税费总价 NZD 890，含早餐；页面标为“免费取消”和“立即预订、稍后付款”。页面未显示免费取消的截止时间或具体扣款日期。",
    availabilityNoteEn:
      "Verified in Pen-y-bryn Lodge's direct SiteMinder engine on 3 Aug 2026 for 6–7 Oct, two guests and one room: the Garden Superior Room was available at NZD 890 including taxes and fees, with breakfast included. It was labelled “Free cancellation” and “Book now, pay later”. The page did not state a free-cancellation deadline or a specific charge date.",
    rateSnapshots: {
      "2026-10-06/2026-10-07": {
        roomRates: {
          "garden-room": {
            official: {
              source: "Pen-y-bryn Lodge 官网 SiteMinder",
              sourceEn: "Pen-y-bryn Lodge direct SiteMinder",
              roomKey: "garden-room",
              room: "Garden Superior Room · Super King · 独立卫浴与起居区",
              roomEn: "Garden Superior Room · super king · private en-suite and sitting area",
              nonRefundableNzd: null,
              refundableNzd: 890,
              cancelUntil: "页面仅标示“免费取消”，未显示截止时间",
              cancelUntilEn: "The page only labelled the rate “Free cancellation” and did not show a deadline",
              refundableRateLabel: "官网含税费总价 · 含早餐 · 免费取消截止时间待确认",
              refundableRateLabelEn: "Direct total including taxes and fees · breakfast included · free-cancellation deadline pending confirmation",
              payment: "页面标为“立即预订、稍后付款”；未显示具体扣款日期，付款前仍须复核",
              paymentEn: "Labelled “Book now, pay later”; the page did not state a specific charge date, so recheck before payment",
              breakfast: "页面明确标示含早餐",
              breakfastEn: "Breakfast was explicitly included on the page",
              quotedAt: "2026-08-03",
            },
          },
        },
    ...
    officialStatus: "exact-rate-verified",
    officialStatusDetail:
      "2026-08-03 已在 Pen-y-bryn Lodge 官方 SiteMinder 预订页按 2026 年 10 月 6—7 日、2 人 1 间核验：Garden Superior Room 可订，含税费总价 NZD 890，含早餐。页面标为“免费取消”和“立即预订、稍后付款”；免费取消截止时间及具体扣款日期没有显示。",
    officialStatusEn:
      "Verified on 3 Aug 2026 in Pen-y-bryn Lodge's direct SiteMinder engine for 6–7 Oct 2026 and two guests: the Garden Superior Room was available at NZD 890 including taxes and fees, with breakfast included. It was labelled “Free cancellation” and “Book now, pay later”; the free-cancellation deadline and specific charge date were not shown.",
    officialVerifiedAt: "2026-08-03",
    officialLinkRetainsSearch: true,
    ...
    officialBookingUrl: "https://book-directonline.com/properties/penybrynlodgedirect?locale=en&checkInDate=2026-10-06&checkOutDate=2026-10-07&currency=NZD&items[0][adults]=2&items[0][children]=0&items[0][infants]=0&trackPage=no",
