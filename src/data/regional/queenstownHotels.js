...
export const queenstownHotels = [
    ...
    },
    {
      ...
      recommendation: "小红书湖景民宿方向 · 当期无房",
      recommendationEn: "Social-media-led Airbnb · unavailable for this stay",
      summary:
      ...
      cautions: [
        ...
        "2026 年 9 月 29 日—10 月 3 日、2 人当前明确无房，不能作为本期可选住宿",
        "另有 1 张沙发床但无需使用",
      ],
      cautionsEn: [
        "Outside the walkable town-centre area",
        "Driving and city parking are required for the Walter Peak departure",
        "It is explicitly unavailable for 29 Sep–3 Oct 2026 and two guests, so it is not selectable for this stay",
      ...
      availabilityNote:
        "2026-08-03 已在 Airbnb 具体房源页按 2026 年 9 月 29 日—10 月 3 日、2 人核验；页面显示“Those dates are not available”，没有可选房型或当前总价。仅保留为当期不可选参考，不以旧报价或其他日期库存替代。",
      availabilityNoteEn:
        "The concrete Airbnb listing was checked on 3 Aug 2026 for 29 Sep–3 Oct 2026 and two guests. It showed “Those dates are not available”, with no selectable room or current total. It remains a non-selectable reference for this stay; no old quote or another-date inventory is substituted.",
      rateSnapshots: {},
      research: sharedSocial.queenstown,
      officialStatus: "exact-date-unavailable",
      officialStatusDetail:
        "2026-08-03 已在 Airbnb 具体房源页按 2026 年 9 月 29 日—10 月 3 日、2 人核验；预订信息区域明确显示“Those dates are not available”。页面没有返回可选房型或目标日期总价，已清除旧的 NZD 1,924 报价与取消条款，不以其他日期或渠道库存替代。",
      officialStatusEn:
        "The concrete Airbnb listing was checked on 3 Aug 2026 for 29 Sep–3 Oct and two guests. Its booking-information area explicitly showed “Those dates are not available”. It returned no selectable room or total for the target stay, so the former NZD 1,924 quote and cancellation terms have been removed rather than substituted with another date or channel.",
    ...
    },
    {
      ...
      recommendationEn: "Best walkable Airbnb · unavailable for this stay",
      summary:
        "镇中心一卧室整套公寓，步行可覆盖 Steamer Wharf、湖边、餐厅与 Queenstown Gardens，适合 Walter Peak 当天不用开车；但 Airbnb 已明确显示本次目标四晚无房，不能作为本期可选住宿。",
      summaryEn:
        "A central one-bedroom Airbnb with the strongest walkability for Steamer Wharf and town activities, but explicitly unavailable for this four-night stay.",
      access: "镇中心；房源标题明确标注可步行到各处",
      accessEn: "Central Queenstown with walk-everywhere positioning",
      parking: "房源页列出内部免费车棚，可停 1 辆车；预订前仍应确认通道和实际车位",
      parkingEn: "The listing shows one free on-site carport; confirm access and the actual bay before booking",
      distanceNote:
      ...
      strengthsEn: [
        ...
        "Listing shows one free on-site carport",
      ],
      cautions: [
        "2026 年 9 月 29 日—10 月 3 日、2 人当前明确无房，不能作为本期可选住宿",
        "Airbnb 精确地址订后才公开",
      ...
      hotelImages: [],
      availabilityNote:
        "2026-08-03 已在 Airbnb 具体房源页按 2026 年 9 月 29 日—10 月 3 日、2 人核验；预订区域显示“该房源在指定日期不可出租”，没有可选房型或当前总价。仅保留为当期不可选参考，不以旧报价或其他日期库存替代。",
      availabilityNoteEn:
        "The concrete Airbnb listing was checked on 3 Aug 2026 for 29 Sep–3 Oct 2026 and two guests. Its booking area stated that the listing is not available for the selected dates, with no selectable room or current total. It remains a non-selectable reference for this stay; no old quote or another-date inventory is substituted.",
      rateSnapshots: {},
      research: sharedSocial.queenstown,
      officialStatus: "exact-date-unavailable",
      officialStatusDetail:
        "2026-08-03 已在 Airbnb 具体房源页按 2026 年 9 月 29 日—10 月 3 日、2 人核验；预订区域明确显示“该房源在指定日期不可出租”。页面没有返回可选房型或目标日期总价，已清除旧的 NZD 2,046 报价与取消条款，不以其他日期或渠道库存替代。",
      officialStatusEn:
        "The concrete Airbnb listing was checked on 3 Aug 2026 for 29 Sep–3 Oct and two guests. Its booking area explicitly stated that the listing is not available for the selected dates. It returned no selectable room or total for the target stay, so the former NZD 2,046 quote and cancellation terms have been removed rather than substituted with another date or channel.",
      officialVerifiedAt: "2026-08-03",
      officialUrl:
    ...
    },
    {
      ...
      summary:
        "Lake Hayes 农场单间公寓，有山谷景观、厨房、洗衣机和免费停车；代价是每天都要开车进镇，Walter Peak 当天也无法步行到码头。",
      summaryEn:
        "A quiet Lake Hayes farmstay with a kitchen and parking, but daily driving is required.",
      ...
      cautions: [
        "目标日期 2 人当前明确不可订；需改期或另选住宿",
        "所有皇后镇活动都需开车",
        "Walter Peak 当天要处理市区停车",
        "Airbnb 精确地址订后才公开",
      ],
      cautionsEn: [
        "The target two-guest stay is currently explicitly unavailable; change dates or choose another stay",
      ...
      hotelImages: [],
      availabilityNote:
        "Airbnb IAB 已按 2026 年 9 月 29 日—10 月 3 日、2 人核验：具体房源页明确显示“该房源在指定日期不可出租”。当前没有可复现价格、费用或付款条件。",
      availabilityNoteEn:
        "Airbnb was checked for 29 Sep–3 Oct 2026 and two guests: the concrete listing explicitly says it is not available for the selected dates. No current price, fee, or payment terms were reproducible.",
      rateSnapshots: {},
      research: sharedSocial.queenstown,
      officialStatus: "exact-date-unavailable",
      officialStatusDetail:
        "2026-08-03 已在 Airbnb 具体房源页按 9 月 29 日—10 月 3 日、2 人核验；页面明确显示“该房源在指定日期不可出租”。这只证明当前目标条件无房，不代表其他日期无房。",
      officialStatusEn:
        "The concrete Airbnb listing was checked on 3 Aug 2026 for 29 Sep–3 Oct and two guests. The page explicitly states that the listing is not available for the selected dates. This establishes unavailability only for the target conditions, not for other dates.",
      officialVerifiedAt: "2026-08-03",
      officialUrl:
    ...
    },
    {
      ...
      strengths: ["镇中心步行动线好", "27 m² 公寓带小厨房", "官网标准价可在到店前 48 小时、15:00 前取消以避免首晚费用", "四晚不搬行李"],
      strengthsEn: ["Strong central walking route", "27 m² studio with kitchenette", "The direct Standard Rate can be cancelled by 3 pm, 48 hours before arrival to avoid a first-night charge", "No room change for four nights"],
      cautions: ["停车四晚另加约 NZD 120", "官网动态总价已于 8 月 3 日核验，付款前仍应刷新", "官网结果卡未显示床型，入住前确认大床配置"],
      cautionsEn: ["Parking adds about NZD 120", "The dynamic direct total was checked on 3 Aug and should still be refreshed before payment", "The direct result card did not display bedding; confirm the large-bed configuration before booking"],
      ...
      availabilityNote:
        "2026-08-03 已在 Ramada by Wyndham 官网按 2026 年 9 月 29 日入住、10 月 3 日退房、2 位成人、1 间、NZD 核验 Studio Apartment（27 m²）：公开 Standard Rate 的四晚总价 NZD 2,425，逐晚 NZD 599 / 610 / 610 / 606；页面明确 GST 15% 已含在房价内，税费及服务费合计 NZD 0。该价标为 Book & Pay Later；条款写明须以有效信用卡担保，到店前 48 小时、15:00 前取消可避免首晚费用，实际房费扣款时点未显示。官网结果未显示早餐或床型。2026-07-27 的 Booking.com 价格保留为历史平台参考，不与当前官网总价混写。",
      availabilityNoteEn:
        "On 3 Aug 2026, Ramada by Wyndham's direct site was checked for 29 Sep check-in, 3 Oct check-out, two adults, one room and NZD. The 27 m² Studio Apartment's public Standard Rate totalled NZD 2,425 for four nights, with nightly amounts NZD 599 / 610 / 610 / 606. The page explicitly said 15% GST was included in room rate and listed NZD 0 total taxes and service charges. It was labelled Book & Pay Later; terms require a valid-card guarantee and allow cancellation by 3 pm, 48 hours before arrival to avoid a first-night charge, while actual room-charge timing was not shown. The direct result did not show breakfast or bedding. Booking.com's 27 Jul price is retained as historic platform reference and is not mixed with the current direct total.",
      rateSnapshots: {
        "2026-09-29/2026-10-03": {
          roomRates: {
            "studio-king": {
              official: {
                source: "Ramada by Wyndham Queenstown Central 官网预订引擎",
                sourceEn: "Ramada by Wyndham Queenstown Central direct booking engine",
                roomKey: "studio-king",
                room: "Studio Apartment · 27 m² · 4 晚",
                roomEn: "Studio Apartment · 27 m² · four nights",
                nonRefundableNzd: null,
                refundableNzd: 2425,
                cancelUntil: "到店前 48 小时、15:00 前（酒店当地时间）",
                cancelUntilEn: "by 3 pm, 48 hours before arrival (hotel local time)",
                refundableRateLabel: "公开 Standard Rate · Book & Pay Later · 4 晚总价 · GST 15% 已含",
                refundableRateLabelEn: "Public Standard Rate · Book & Pay Later · four-night stay total · 15% GST included",
                payment: "须以有效信用卡担保；页面标为 Book & Pay Later，但未显示实际房费扣款时点",
                paymentEn: "A valid credit card is required to guarantee the reservation; the page says Book & Pay Later but does not show the actual room-charge timing",
                breakfast: "官网目标结果未显示是否含早餐或早餐加价",
                breakfastEn: "The direct target result did not show breakfast inclusion or a breakfast supplement",
                memberNote: "目标条件：2026-09-29 入住、2026-10-03 退房、2 位成人、1 间、NZD；逐晚 NZD 599 / 610 / 610 / 606，税费及服务费合计 NZD 0，因为 GST 15% 已含在房价内。",
                memberNoteEn: "Search conditions: 29 Sep 2026 check-in, 3 Oct 2026 check-out, two adults, one room and NZD. Nightly amounts were NZD 599 / 610 / 610 / 606; total taxes and service charges were NZD 0 because 15% GST is included in room rate.",
                quotedAt: "2026-08-03",
              },
              booking: {
                source: "Booking.com · Genius 1（历史平台参考）",
                sourceEn: "Booking.com · Genius 1 (historic platform reference)",
                roomKey: "studio-king",
                room: "一室公寓 · 27 m²",
                roomEn: "Studio apartment · 27 m²",
                nonRefundableNzd: 1984,
                refundableNzd: 2204,
                cancelUntil: "2026-09-28",
                payment: "可取消档在 9 月 26 日前（不含当日）零付款",
                paymentEn: "The cancellable rate required no payment before 26 Sep (excluding that date)",
                breakfast: "早餐可另购",
                breakfastEn: "Breakfast available at extra cost",
                quotedAt: "2026-07-27",
              },
            },
          },
      ...
      officialStatus: "exact-rate-verified",
      officialStatusDetail:
        "2026-08-03 已在 Ramada by Wyndham 官网按 9 月 29 日—10 月 3 日、2 人 1 间、NZD 核验 Studio Apartment（27 m²）：公开 Standard Rate 四晚总价 NZD 2,425，GST 15% 已含；逐晚 NZD 599 / 610 / 610 / 606。该价标为 Book & Pay Later，须有效信用卡担保；到店前 48 小时、15:00 前取消可避免首晚费用，实际房费扣款时点未显示。早餐和床型未显示，均不作推断。",
      officialStatusEn:
        "On 3 Aug 2026, Ramada by Wyndham's direct site verified its Studio Apartment (27 m²) for 29 Sep–3 Oct, two adults, one room and NZD: the public Standard Rate totalled NZD 2,425 for four nights, with 15% GST included and nightly amounts NZD 599 / 610 / 610 / 606. It is labelled Book & Pay Later and requires a valid-card guarantee; cancellation by 3 pm, 48 hours before arrival avoids a first-night charge, while actual room-charge timing was not shown. Breakfast and bedding were not displayed, so neither is inferred.",
      officialVerifiedAt: "2026-08-03",
      officialUrl: "https://www.wyndhamhotels.com/ramada/queenstown-new-zealand/ramada-queenstown-central/overview",
      officialBookingUrl: "https://www.wyndhamhotels.com/ramada/queenstown-new-zealand/ramada-queenstown-central/overview",
      officialLinkRetainsSearch: false,
      officialLinkLabel: "打开 Ramada 官网并重新选择目标日期",
      officialLinkLabelEn: "Open Ramada direct booking and reselect the target dates",
      officialLinkNote: "请重新选择 2026 年 9 月 29 日—10 月 3 日、2 位成人、1 间和 NZD；2026-08-03 保存的 Studio Apartment 公开 Standard Rate 四晚总价为 NZD 2,425。付款前刷新动态价格，并确认床型、早餐、停车和实际扣款时点。",
      officialLinkNoteEn: "Reselect 29 Sep–3 Oct 2026, two adults, one room and NZD. The saved public Studio Apartment Standard Rate was NZD 2,425 for four nights on 3 Aug 2026. Refresh the dynamic rate and confirm bedding, breakfast, parking and actual charge timing before payment.",
    ...
    },
    {
      ...
      summary:
        "就在 Beach Street 湖边，位置评分 9.8，去 Steamer Wharf 与镇中心最直接；当前保留的湖景阳台 King 有精确房型图片。IHG 官网可复现的会员早餐套餐四晚总价为 NZD 4,670.20；它要求免费加入 IHG One Rewards，不能当作所有访客的公开价。",
      summaryEn:
        "The strongest hotel for wharf walkability. The retained lake-view balcony king has exact-category photos. IHG's reproducible member breakfast package totals NZD 4,670.20 for four nights; it requires free IHG One Rewards enrolment and is not presented as a public rate for every traveller.",
      access: "Beach Street 湖边；Steamer Wharf 对面一带",
      accessEn: "Lakefront Beach Street, next to the wharf precinct",
      parking: "IHG 结算前附加项列 Overnight Hotel Parking 为每晚 NZD 38，且不含在本次房价内；是否有位与 valet 交接仍须付款前确认",
      parkingEn: "IHG's pre-checkout add-ons list Overnight Hotel Parking at NZD 38 per night, not included in this stay's room rate; confirm space availability and valet handover before payment",
      nearbyAttractions: [
        {
          name: "Steamer Wharf · Walter Peak 码头",
      ...
      strengths: [
        ...
        "会员早餐套餐含早餐",
        "会员早餐套餐可在 8 月 30 日 18:00 前免费取消",
        "位置评分 9.8",
      ],
      strengthsEn: [
        "Almost no transport needed on the Walter Peak day",
        "A currently available lake-view balcony room with a guaranteed king bed",
        "Fifteen platform room photos verified, with five selected for display",
        "Breakfast included in the member breakfast package",
        "The member breakfast package is cancellable free of charge until 6:00 pm on 30 Aug",
        "9.8 location score",
      ],
      cautions: [
        "当前保留的湖景阳台 King 四晚总价高",
        "停车另收费，每晚 NZD 38",
        "官网精确总价为 IHG One Rewards 会员专属价；非会员公开总价未在结算前复现",
        "性价比评分仅 7.6",
      ],
      cautionsEn: [
        "The retained lake-view balcony king has a high four-night total",
        "Parking costs NZD 38 per night",
        "The direct exact total is an IHG One Rewards member-only rate; a public non-member total was not reproduced before checkout",
      ...
      roomTypes: [
        {
          ...
          name: "湖景阳台特大床房",
          nameEn: "1 King Standard Lake View Balcony",
          size: "IHG 官网 25—26 m²；Booking.com 标为 32 m²",
          sizeEn: "IHG direct: 25–26 m²; Booking.com lists 32 m²",
          bed: "1 张超大号双人床",
          bedEn: "One king bed",
          photosVerified: true,
      ...
      hotelImages: [],
      availabilityNote:
        "当前仅展示有对应房型图片的 Lake View King with Balcony。2026-08-03 已在 IHG 官网按 2026 年 9 月 29 日—10 月 3 日、2 人 1 间核验相同的 1 King Standard Lake View Balcony：IHG One Rewards 会员早餐套餐含 GST 总价 NZD 4,670.20，今天不扣款，信用卡只作到店当日保留；可在 8 月 30 日 18:00 前免费取消。该价格要求免费加入 IHG One Rewards，不能当作非会员公开价；非会员公开总价尚未在结算前复现。停车附加项为每晚 NZD 38。",
      availabilityNoteEn:
        "Only the Lake View King with Balcony, which has exact-category photos, remains displayed. On 3 Aug 2026 IHG was checked for the matching 1 King Standard Lake View Balcony for 29 Sep–3 Oct 2026, two guests and one room: the IHG One Rewards member breakfast package totalled NZD 4,670.20 including GST, with no charge today and a card hold until arrival. It can be cancelled free of charge before 6:00 pm on 30 Aug. This price requires free IHG One Rewards enrolment and is not presented as a public non-member rate; a public total was not reproduced before checkout. Parking is a NZD 38-per-night add-on.",
      rateSnapshots: {
        "2026-09-29/2026-10-03": {
          roomRates: {
            "lake-view-balcony-king": {
              official: {
                ...
                room: "1 King Standard Lake View Balcony · 4 晚 · 含早餐",
                roomEn: "1 King Standard Lake View Balcony · four nights · breakfast included",
                nonRefundableNzd: null,
                refundableNzd: 4670.2,
                cancelUntil: "2026-08-30 18:00 前免费取消",
                cancelUntilEn: "Free cancellation before 6:00 pm on 30 Aug 2026",
                refundableRateLabel: "IHG One Rewards 会员早餐套餐 · 含 GST · 到店付款",
                refundableRateLabelEn: "IHG One Rewards member breakfast package · GST included · pay at property",
                payment: "今天不扣款；信用卡只用于保留至入住当天",
                paymentEn: "Nothing is charged today; the card only holds the reservation until the arrival day",
                breakfast: "含早餐",
                breakfastEn: "Breakfast included",
                memberNote: "该精确总价要求免费加入 IHG One Rewards。结果页仅显示非会员每晚起价，未在结算前取得非会员总价。",
                memberNoteEn: "This exact total requires free IHG One Rewards enrolment. The results page showed only a non-member nightly starting price; a non-member total was not obtained before checkout.",
                quotedAt: "2026-08-03",
              },
              booking: {
                source: "Booking.com",
      ...
      officialStatus: "exact-rate-verified",
      officialStatusDetail:
        "2026-08-03 已在 IHG 官网按 2026 年 9 月 29 日—10 月 3 日、2 人 1 间核验 1 King Standard Lake View Balcony：IHG One Rewards 会员早餐套餐含 GST 总价 NZD 4,670.20，今天不扣款、信用卡保留至入住当天；可在 8 月 30 日 18:00 前免费取消。该套餐要求免费加入 IHG One Rewards；非会员公开总价未在结算前复现。",
      officialStatusEn:
        "Verified on IHG on 3 Aug 2026 for the 1 King Standard Lake View Balcony, 29 Sep–3 Oct 2026 and two guests: the IHG One Rewards member breakfast package totalled NZD 4,670.20 including GST, with nothing charged today and the card held until the arrival day. It can be cancelled free of charge before 6:00 pm on 30 Aug. This package requires free IHG One Rewards enrolment; a public non-member total was not reproduced before checkout.",
      officialVerifiedAt: "2026-08-03",
