...
const eventTranslations = {
  ...
  "酒店退房并寄存行李": "Check out and leave luggage with the hotel",
  "纸板教堂、Latimer Square 与市中心自由活动": "Cardboard Cathedral, Latimer Square and free time in the central city",
  "午餐、最后逛街或咖啡；14:15 返回酒店取行李": "Lunch and final shopping or coffee; return to the hotel for luggage at 14:15",
  "按新确认邮件安排出发，驾车前往基督城机场；途中预留加油与道路缓冲": "Depart according to the updated confirmation and drive to Christchurch Airport with time for fuel and road delays",
  "Budget 基督城机场还车（已修改到10月8日；具体时刻、新总价与条款待新确认邮件核验）": "Return the Budget car at Christchurch Airport on 8 October; the exact time, new total and terms await the updated confirmation email",
  "进入国内航站楼，不再返回市区": "Enter the domestic terminal after returning the car; do not return to the city",
  "值机开放后办理手续并预留晚点缓冲": "Check in when the desk opens and retain a delay buffer",
  "JQ242 基督城 → 奥克兰；Google Flights 2026-07-29 快照为 NZD 156/人起，通常可能晚点30分钟以上；行李等可选费用与最终价格须在捷星官网结账核验": "JQ242 Christchurch → Auckland; a 29 Jul 2026 Google Flights snapshot showed fares from NZD 156 per person and noted delays of 30+ minutes are common. Verify optional baggage fees and the final price at Jetstar checkout",
  "计划抵达奥克兰，随后前往奥克兰市中心酒店": "Scheduled arrival in Auckland, then travel to the central Auckland hotel",
  ...
  "市中心酒店退房并寄存行李": "Check out and leave luggage with the central Auckland hotel",
...
const dayTranslations = {
  ...
  "10月7日": ["Ōamaru → Christchurch", "Drive north and enjoy a slow late afternoon in central Christchurch", "Stay · central Christchurch, one night; accommodation is not booked yet."],
  "10月8日": ["Christchurch → Auckland", "Continue exploring Christchurch, then take evening JQ242", "Stay · central Auckland, night 1; go straight to the hotel and allow for the 07:00 Hobbiton coach check-in the next morning."],
  "10月9日": ["Auckland ⇄ Hobbiton", "GreatSights GS10H coach day tour", "Stay · the same central Auckland hotel, night 2; no checkout, hotel change or rental car."],
  "10月10日": ["Auckland half-day → Auckland Airport", "Leave luggage, enjoy an easy half-day and transfer to the airport", "No hotel tonight; wait at Auckland Airport for the flight just after midnight."],
