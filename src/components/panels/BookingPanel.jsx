...
const accommodationCalendar = [
  ...
  { date: "10/3", bookingId: "hotel-wanaka", stayGroup: "wanaka", hotel: wanakaBooking.listingName, hotelEn: wanakaBooking.listingNameEn, place: "瓦纳卡", placeEn: "Wānaka", status: "第 1 晚", statusEn: "Night 1", tone: "wanaka", confirmed: true, position: wanakaBooking.mapPosition, mapQuery: wanakaBooking.mapQuery },
  ...
  { date: "10/5", bookingId: "mount-cook", stayGroup: "mount-cook", hotel: "The Hermitage · Mt Cook Motel Studio Queen", place: "库克山村", placeEn: "Aoraki / Mount Cook Village", status: "住 1 晚", statusEn: "1 night", tone: "mount-cook", confirmed: true, position: confirmedAccommodationBookings["mount-cook"].mapPosition, mapQuery: confirmedAccommodationBookings["mount-cook"].mapQuery },
